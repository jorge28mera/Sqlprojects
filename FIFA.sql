...
ALTER TABLE stats 
CHANGE COLUMN `possession team1` possession_team1 decimal(5,2),
CHANGE COLUMN `possession team2` possession_team2 decimal(5,2);

ALTER TABLE stats 
CHANGE COLUMN `possession in contest` possession_in_contest decimal(5,2),
CHANGE COLUMN `conceded team1` goals_conceded int,
CHANGE COLUMN `number of goals team1` number_of_goals_team1 INT,
CHANGE COLUMN `number of goals team2` number_of_goals_team2 INT,
CHANGE COLUMN `total attempts team1` total_attempts_team1 INT,
CHANGE COLUMN `total attempts team2` total_attempts_team2 INT,
CHANGE COLUMN `goal inside the penalty area team1` goals_in_penalty_area_team1 int,
CHANGE COLUMN `goal inside the penalty area team2` goals_in_penalty_area_team2 int,
CHANGE COLUMN `goal outside the penalty area team1` goals_out_penalty_area_team1 int,
CHANGE COLUMN `goal outside the penalty area team2` goals_out_penalty_area_team2 int,
CHANGE COLUMN `assists team1` assits_team1 int,
CHANGE COLUMN `assists team2` assits_team2 int,
CHANGE COLUMN `on target attempts team1` attempts_on_target_team1 int,
CHANGE COLUMN `on target attempts team2` attempts_on_target_team2 int,
CHANGE COLUMN `off target attempts team1` attempts_off_target_team1 int,
CHANGE COLUMN `off target attempts team2` attempts_off_target_team2 int,
CHANGE COLUMN `left channel team1` left_channel_team1 int,
CHANGE COLUMN `left channel team2` left_channel_team2 int,
CHANGE COLUMN `left inside channel team1` left_inside_channel_team1 int,
CHANGE COLUMN `left inside channel team2` left_inside_channel_team2 int,
CHANGE COLUMN `central channel team1` central_channel_team1 int,
CHANGE COLUMN `central channel team2` central_channel_team2 int,
CHANGE COLUMN `right inside channel team1` right_inside_channel_team1 int,
CHANGE COLUMN `right inside channel team2` right_inside_channel_team2 int,
CHANGE COLUMN `right channel team1` right_channel_team1 int,
CHANGE COLUMN `right channel team2` right_channel_team2 int,
CHANGE COLUMN `attempted line breaks team1` attempted_line_breaks_team1 int,
CHANGE COLUMN `attempted line breaks team2` attempted_line_breaks_team2 int,
CHANGE COLUMN `completed line breaksteam1` completed_line_breaks_team1 int,
CHANGE COLUMN `completed line breaks team2` completed_line_breaks_team2 int,
CHANGE COLUMN `attempted defensive line breaks team1` attempted_defen_line_breaks_team1 int,
CHANGE COLUMN `attempted defensive line breaks team2` attempted_defen_line_breaks_team2 int,
...
ALTER TABLE stats 
CHANGE COLUMN `goals_conceded` goals_conceded_t1 INT,
...
-- How many yellow and red cards were shown to each team?
select t.team,
sum(CASE
